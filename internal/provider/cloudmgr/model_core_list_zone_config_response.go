...
type CoreListZoneConfigResponse struct {
	Content *[]CoreDescribeZoneConfigResponse `json:"content,omitempty"`
...
func NewCoreListZoneConfigResponse() *CoreListZoneConfigResponse {
	this := CoreListZoneConfigResponse{}
	return &this
}
...
func (o *CoreListZoneConfigResponse) GetContent() []CoreDescribeZoneConfigResponse {
	if o == nil || o.Content == nil {
		var ret []CoreDescribeZoneConfigResponse
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given []CoreDescribeZoneConfigResponse and assigns it to the Content field.
...
func (o CoreListZoneConfigResponse) MarshalJSON() ([]byte, error) {
...
type NullableCoreListZoneConfigResponse struct {
	value *CoreListZoneConfigResponse
	isSet bool
}

func (v NullableCoreListZoneConfigResponse) Get() *CoreListZoneConfigResponse {
	return v.value
}

func (v *NullableCoreListZoneConfigResponse) Set(val *CoreListZoneConfigResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreListZoneConfigResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreListZoneConfigResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreListZoneConfigResponse(val *CoreListZoneConfigResponse) *NullableCoreListZoneConfigResponse {
	return &NullableCoreListZoneConfigResponse{value: val, isSet: true}
}

func (v NullableCoreListZoneConfigResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreListZoneConfigResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
