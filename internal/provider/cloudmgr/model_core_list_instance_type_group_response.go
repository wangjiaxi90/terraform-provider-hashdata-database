...
type CoreListInstanceTypeGroupResponse struct {
	Content *[]CoreDescribeInstanceTypeGroupResponse `json:"content,omitempty"`
...
func NewCoreListInstanceTypeGroupResponse() *CoreListInstanceTypeGroupResponse {
	this := CoreListInstanceTypeGroupResponse{}
	return &this
}
...
func (o *CoreListInstanceTypeGroupResponse) GetContent() []CoreDescribeInstanceTypeGroupResponse {
	if o == nil || o.Content == nil {
		var ret []CoreDescribeInstanceTypeGroupResponse
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given []CoreDescribeInstanceTypeGroupResponse and assigns it to the Content field.
...
func (o CoreListInstanceTypeGroupResponse) MarshalJSON() ([]byte, error) {
...
type NullableCoreListInstanceTypeGroupResponse struct {
	value *CoreListInstanceTypeGroupResponse
	isSet bool
}

func (v NullableCoreListInstanceTypeGroupResponse) Get() *CoreListInstanceTypeGroupResponse {
	return v.value
}

func (v *NullableCoreListInstanceTypeGroupResponse) Set(val *CoreListInstanceTypeGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreListInstanceTypeGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreListInstanceTypeGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreListInstanceTypeGroupResponse(val *CoreListInstanceTypeGroupResponse) *NullableCoreListInstanceTypeGroupResponse {
	return &NullableCoreListInstanceTypeGroupResponse{value: val, isSet: true}
}

func (v NullableCoreListInstanceTypeGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreListInstanceTypeGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
