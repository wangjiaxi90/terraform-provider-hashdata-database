...
type AccountListTeamOfUserResponse struct {
	Content *[]AccountDescribeTeamOfUserResponse `json:"content,omitempty"`
...
func NewAccountListTeamOfUserResponse() *AccountListTeamOfUserResponse {
	this := AccountListTeamOfUserResponse{}
	return &this
}
...
func (o *AccountListTeamOfUserResponse) GetContent() []AccountDescribeTeamOfUserResponse {
	if o == nil || o.Content == nil {
		var ret []AccountDescribeTeamOfUserResponse
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given []AccountDescribeTeamOfUserResponse and assigns it to the Content field.
...
func (o AccountListTeamOfUserResponse) MarshalJSON() ([]byte, error) {
...
type NullableAccountListTeamOfUserResponse struct {
	value *AccountListTeamOfUserResponse
	isSet bool
}

func (v NullableAccountListTeamOfUserResponse) Get() *AccountListTeamOfUserResponse {
	return v.value
}

func (v *NullableAccountListTeamOfUserResponse) Set(val *AccountListTeamOfUserResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountListTeamOfUserResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountListTeamOfUserResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountListTeamOfUserResponse(val *AccountListTeamOfUserResponse) *NullableAccountListTeamOfUserResponse {
	return &NullableAccountListTeamOfUserResponse{value: val, isSet: true}
}

func (v NullableAccountListTeamOfUserResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountListTeamOfUserResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
