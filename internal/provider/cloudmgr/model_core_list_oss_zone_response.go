...
type CoreListOssZoneResponse struct {
	Content *[]CoreDescribeOssZoneResponse `json:"content,omitempty"`
...
func (o *CoreListOssZoneResponse) GetContent() []CoreDescribeOssZoneResponse {
	if o == nil || o.Content == nil {
		var ret []CoreDescribeOssZoneResponse
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given []CoreDescribeOssZoneResponse and assigns it to the Content field.
...
func (o CoreListOssZoneResponse) MarshalJSON() ([]byte, error) {
...
type NullableCoreListOssZoneResponse struct {
	value *CoreListOssZoneResponse
	isSet bool
}

func (v NullableCoreListOssZoneResponse) Get() *CoreListOssZoneResponse {
	return v.value
}

func (v *NullableCoreListOssZoneResponse) Set(val *CoreListOssZoneResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreListOssZoneResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreListOssZoneResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreListOssZoneResponse(val *CoreListOssZoneResponse) *NullableCoreListOssZoneResponse {
	return &NullableCoreListOssZoneResponse{value: val, isSet: true}
}

func (v NullableCoreListOssZoneResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreListOssZoneResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
