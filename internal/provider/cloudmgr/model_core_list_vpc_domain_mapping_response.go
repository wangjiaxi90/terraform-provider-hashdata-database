...
type CoreListVpcDomainMappingResponse struct {
	Content *[]CoreDescribeVpcDomainMappingResponse `json:"content,omitempty"`
...
func NewCoreListVpcDomainMappingResponse() *CoreListVpcDomainMappingResponse {
	this := CoreListVpcDomainMappingResponse{}
	return &this
}
...
func (o *CoreListVpcDomainMappingResponse) GetContent() []CoreDescribeVpcDomainMappingResponse {
	if o == nil || o.Content == nil {
		var ret []CoreDescribeVpcDomainMappingResponse
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given []CoreDescribeVpcDomainMappingResponse and assigns it to the Content field.
...
func (o CoreListVpcDomainMappingResponse) MarshalJSON() ([]byte, error) {
...
type NullableCoreListVpcDomainMappingResponse struct {
	value *CoreListVpcDomainMappingResponse
	isSet bool
}

func (v NullableCoreListVpcDomainMappingResponse) Get() *CoreListVpcDomainMappingResponse {
	return v.value
}

func (v *NullableCoreListVpcDomainMappingResponse) Set(val *CoreListVpcDomainMappingResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreListVpcDomainMappingResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreListVpcDomainMappingResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreListVpcDomainMappingResponse(val *CoreListVpcDomainMappingResponse) *NullableCoreListVpcDomainMappingResponse {
	return &NullableCoreListVpcDomainMappingResponse{value: val, isSet: true}
}

func (v NullableCoreListVpcDomainMappingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreListVpcDomainMappingResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
