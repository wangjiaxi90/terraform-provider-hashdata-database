...
type OpsListMaintenanceUserResponse struct {
	Content *[]OpsDescribeMaintenanceUserResponse `json:"content,omitempty"`
...
func NewOpsListMaintenanceUserResponse() *OpsListMaintenanceUserResponse {
	this := OpsListMaintenanceUserResponse{}
	return &this
}
...
func (o *OpsListMaintenanceUserResponse) GetContent() []OpsDescribeMaintenanceUserResponse {
	if o == nil || o.Content == nil {
		var ret []OpsDescribeMaintenanceUserResponse
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given []OpsDescribeMaintenanceUserResponse and assigns it to the Content field.
...
func (o OpsListMaintenanceUserResponse) MarshalJSON() ([]byte, error) {
...
type NullableOpsListMaintenanceUserResponse struct {
	value *OpsListMaintenanceUserResponse
	isSet bool
}

func (v NullableOpsListMaintenanceUserResponse) Get() *OpsListMaintenanceUserResponse {
	return v.value
}

func (v *NullableOpsListMaintenanceUserResponse) Set(val *OpsListMaintenanceUserResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOpsListMaintenanceUserResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOpsListMaintenanceUserResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpsListMaintenanceUserResponse(val *OpsListMaintenanceUserResponse) *NullableOpsListMaintenanceUserResponse {
	return &NullableOpsListMaintenanceUserResponse{value: val, isSet: true}
}

func (v NullableOpsListMaintenanceUserResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpsListMaintenanceUserResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
