...
type CoreListInstanceTypeResponse struct {
	Content *[]CoreDescribeInstanceTypeResponse `json:"content,omitempty"`
...
func NewCoreListInstanceTypeResponse() *CoreListInstanceTypeResponse {
	this := CoreListInstanceTypeResponse{}
	return &this
}
...
func (o *CoreListInstanceTypeResponse) GetContent() []CoreDescribeInstanceTypeResponse {
	if o == nil || o.Content == nil {
		var ret []CoreDescribeInstanceTypeResponse
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given []CoreDescribeInstanceTypeResponse and assigns it to the Content field.
...
func (o CoreListInstanceTypeResponse) MarshalJSON() ([]byte, error) {
...
type NullableCoreListInstanceTypeResponse struct {
	value *CoreListInstanceTypeResponse
	isSet bool
}

func (v NullableCoreListInstanceTypeResponse) Get() *CoreListInstanceTypeResponse {
	return v.value
}

func (v *NullableCoreListInstanceTypeResponse) Set(val *CoreListInstanceTypeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreListInstanceTypeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreListInstanceTypeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreListInstanceTypeResponse(val *CoreListInstanceTypeResponse) *NullableCoreListInstanceTypeResponse {
	return &NullableCoreListInstanceTypeResponse{value: val, isSet: true}
}

func (v NullableCoreListInstanceTypeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreListInstanceTypeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
