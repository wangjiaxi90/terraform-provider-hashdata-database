...
type CoreListJobResponse struct {
	Content *[]CommonDescribeJobResponse `json:"content,omitempty"`
...
// SetContent gets a reference to the given []CommonDescribeJobResponse and assigns it to the Content field.
...
func (o CoreListJobResponse) MarshalJSON() ([]byte, error) {
...
type NullableCoreListJobResponse struct {
	value *CoreListJobResponse
	isSet bool
}

func (v NullableCoreListJobResponse) Get() *CoreListJobResponse {
	return v.value
}

func (v *NullableCoreListJobResponse) Set(val *CoreListJobResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreListJobResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreListJobResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreListJobResponse(val *CoreListJobResponse) *NullableCoreListJobResponse {
	return &NullableCoreListJobResponse{value: val, isSet: true}
}

func (v NullableCoreListJobResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreListJobResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
