...
type CoreListOssZoneConfigResponse struct {
	Content *[]CoreDescribeOssZoneConfigResponse `json:"content,omitempty"`
...
func NewCoreListOssZoneConfigResponse() *CoreListOssZoneConfigResponse {
	this := CoreListOssZoneConfigResponse{}
	return &this
}
...
func (o *CoreListOssZoneConfigResponse) GetContent() []CoreDescribeOssZoneConfigResponse {
	if o == nil || o.Content == nil {
		var ret []CoreDescribeOssZoneConfigResponse
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given []CoreDescribeOssZoneConfigResponse and assigns it to the Content field.
...
func (o CoreListOssZoneConfigResponse) MarshalJSON() ([]byte, error) {
...
type NullableCoreListOssZoneConfigResponse struct {
	value *CoreListOssZoneConfigResponse
	isSet bool
}

func (v NullableCoreListOssZoneConfigResponse) Get() *CoreListOssZoneConfigResponse {
	return v.value
}

func (v *NullableCoreListOssZoneConfigResponse) Set(val *CoreListOssZoneConfigResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreListOssZoneConfigResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreListOssZoneConfigResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreListOssZoneConfigResponse(val *CoreListOssZoneConfigResponse) *NullableCoreListOssZoneConfigResponse {
	return &NullableCoreListOssZoneConfigResponse{value: val, isSet: true}
}

func (v NullableCoreListOssZoneConfigResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreListOssZoneConfigResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
