...
type AccountListClientResponse struct {
	Content *[]AccountDescribeClientResponse `json:"content,omitempty"`
...
func NewAccountListClientResponse() *AccountListClientResponse {
	this := AccountListClientResponse{}
	return &this
}
...
func (o *AccountListClientResponse) GetContent() []AccountDescribeClientResponse {
	if o == nil || o.Content == nil {
		var ret []AccountDescribeClientResponse
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given []AccountDescribeClientResponse and assigns it to the Content field.
...
func (o AccountListClientResponse) MarshalJSON() ([]byte, error) {
...
type NullableAccountListClientResponse struct {
	value *AccountListClientResponse
	isSet bool
}

func (v NullableAccountListClientResponse) Get() *AccountListClientResponse {
	return v.value
}

func (v *NullableAccountListClientResponse) Set(val *AccountListClientResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountListClientResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountListClientResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountListClientResponse(val *AccountListClientResponse) *NullableAccountListClientResponse {
	return &NullableAccountListClientResponse{value: val, isSet: true}
}

func (v NullableAccountListClientResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountListClientResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
