...
type KsyunListResourceUsageResponse struct {
...
func NewKsyunListResourceUsageResponse() *KsyunListResourceUsageResponse {
	this := KsyunListResourceUsageResponse{}
	return &this
}
...
func (o KsyunListResourceUsageResponse) MarshalJSON() ([]byte, error) {
...
type NullableKsyunListResourceUsageResponse struct {
	value *KsyunListResourceUsageResponse
	isSet bool
}

func (v NullableKsyunListResourceUsageResponse) Get() *KsyunListResourceUsageResponse {
	return v.value
}

func (v *NullableKsyunListResourceUsageResponse) Set(val *KsyunListResourceUsageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKsyunListResourceUsageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKsyunListResourceUsageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKsyunListResourceUsageResponse(val *KsyunListResourceUsageResponse) *NullableKsyunListResourceUsageResponse {
	return &NullableKsyunListResourceUsageResponse{value: val, isSet: true}
}

func (v NullableKsyunListResourceUsageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKsyunListResourceUsageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
