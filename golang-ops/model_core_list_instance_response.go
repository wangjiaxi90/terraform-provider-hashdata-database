...
type CoreListInstanceResponse struct {
	Content *[]CoreDescribeInstanceResponse `json:"content,omitempty"`
...
func (o *CoreListInstanceResponse) GetContent() []CoreDescribeInstanceResponse {
	if o == nil || o.Content == nil {
		var ret []CoreDescribeInstanceResponse
		return ret
	}
	return *o.Content
}
...
// SetContent gets a reference to the given []CoreDescribeInstanceResponse and assigns it to the Content field.
...
func (o CoreListInstanceResponse) MarshalJSON() ([]byte, error) {
...
type NullableCoreListInstanceResponse struct {
	value *CoreListInstanceResponse
	isSet bool
}

func (v NullableCoreListInstanceResponse) Get() *CoreListInstanceResponse {
	return v.value
}

func (v *NullableCoreListInstanceResponse) Set(val *CoreListInstanceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreListInstanceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreListInstanceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreListInstanceResponse(val *CoreListInstanceResponse) *NullableCoreListInstanceResponse {
	return &NullableCoreListInstanceResponse{value: val, isSet: true}
}

func (v NullableCoreListInstanceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreListInstanceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
