...
type CoreCalculateResourceUsageResponse struct {
...
func NewCoreCalculateResourceUsageResponse() *CoreCalculateResourceUsageResponse {
	this := CoreCalculateResourceUsageResponse{}
	return &this
}
...
func (o CoreCalculateResourceUsageResponse) MarshalJSON() ([]byte, error) {
...
type NullableCoreCalculateResourceUsageResponse struct {
	value *CoreCalculateResourceUsageResponse
	isSet bool
}

func (v NullableCoreCalculateResourceUsageResponse) Get() *CoreCalculateResourceUsageResponse {
	return v.value
}

func (v *NullableCoreCalculateResourceUsageResponse) Set(val *CoreCalculateResourceUsageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreCalculateResourceUsageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreCalculateResourceUsageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreCalculateResourceUsageResponse(val *CoreCalculateResourceUsageResponse) *NullableCoreCalculateResourceUsageResponse {
	return &NullableCoreCalculateResourceUsageResponse{value: val, isSet: true}
}

func (v NullableCoreCalculateResourceUsageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreCalculateResourceUsageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
