...
type CoreListRoleResponse struct {
	Content *[]CoreDescribeRoleResponse `json:"content,omitempty"`
...
// SetContent gets a reference to the given []CoreDescribeRoleResponse and assigns it to the Content field.
...
func (o CoreListRoleResponse) MarshalJSON() ([]byte, error) {
...
type NullableCoreListRoleResponse struct {
	value *CoreListRoleResponse
	isSet bool
}

func (v NullableCoreListRoleResponse) Get() *CoreListRoleResponse {
	return v.value
}

func (v *NullableCoreListRoleResponse) Set(val *CoreListRoleResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreListRoleResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreListRoleResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreListRoleResponse(val *CoreListRoleResponse) *NullableCoreListRoleResponse {
	return &NullableCoreListRoleResponse{value: val, isSet: true}
}

func (v NullableCoreListRoleResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreListRoleResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
